...
type GreeterClient interface {
	...
	SayHelloStreamReply(ctx context.Context, in *HelloRequest, opts ...grpc.CallOption) (grpc.ServerStreamingClient[HelloResponse], error)
...
func (c *greeterClient) SayHelloStreamReply(ctx context.Context, in *HelloRequest, opts ...grpc.CallOption) (grpc.ServerStreamingClient[HelloResponse], error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
...
type Greeter_SayHelloStreamReplyClient = grpc.ServerStreamingClient[HelloResponse]

func (c *greeterClient) SayHelloBidiStream(ctx context.Context, opts ...grpc.CallOption) (grpc.BidiStreamingClient[HelloRequest, HelloResponse], error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
...
// This type alias is provided for backwards compatibility with existing code that references the prior non-generic stream type by name.
type Greeter_SayHelloBidiStreamClient = grpc.BidiStreamingClient[HelloRequest, HelloResponse]
...
type GreeterServer interface {
	...
	SayHelloStreamReply(*HelloRequest, grpc.ServerStreamingServer[HelloResponse]) error
...
func (UnimplementedGreeterServer) SayHelloStreamReply(*HelloRequest, grpc.ServerStreamingServer[HelloResponse]) error {
	return status.Errorf(codes.Unimplemented, "method SayHelloStreamReply not implemented")
}
func (UnimplementedGreeterServer) SayHelloBidiStream(grpc.BidiStreamingServer[HelloRequest, HelloResponse]) error {
...
func _Greeter_SayHelloStreamReply_Handler(srv interface{}, stream grpc.ServerStream) error {
	...
	return srv.(GreeterServer).SayHelloStreamReply(m, &grpc.GenericServerStream[HelloRequest, HelloResponse]{ServerStream: stream})
}

// This type alias is provided for backwards compatibility with existing code that references the prior non-generic stream type by name.
type Greeter_SayHelloStreamReplyServer = grpc.ServerStreamingServer[HelloResponse]

func _Greeter_SayHelloBidiStream_Handler(srv interface{}, stream grpc.ServerStream) error {
	return srv.(GreeterServer).SayHelloBidiStream(&grpc.GenericServerStream[HelloRequest, HelloResponse]{ServerStream: stream})
}

// This type alias is provided for backwards compatibility with existing code that references the prior non-generic stream type by name.
type Greeter_SayHelloBidiStreamServer = grpc.BidiStreamingServer[HelloRequest, HelloResponse]
